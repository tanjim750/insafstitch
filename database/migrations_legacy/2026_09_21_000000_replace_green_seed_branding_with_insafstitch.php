...
return new class extends Migration
{
    private const REPLACEMENTS = [
        'Green Seeds বীজ ভান্ডার' => 'trizync-solution',
        'Green Seeds Slip' => 'trizync-solution Slip',
        'Green Seed BD' => 'trizync-solution',
        'Green Seeds' => 'trizync-solution',
        'Green Seed' => 'trizync-solution',
        'GreenSeeds' => 'trizync-solution',
        'GreenSeed' => 'trizync-solution',
        'greenseeds' => 'trizync-solution',
        'greenseed' => 'trizync-solution',
    ];
